                    ...
                    <div class="navbar-collapse collapse">
                        <div class="menu">
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation"><a href={{ route('welcome') }} class="active">Home</a></li>
                        ...
                        <div class="row slide-margin">
                            ...
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="{{url('images/slider/img3.png')}}" class="img-responsive">
                                </div>
                            </div>
    ...
    <div class="about">
        <div class="container">
            <div class="col-md-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                <h2>about us</h2>
                <img src="{{url('images/6.jpg')}}" class="img-responsive" />
    ...
    <div class="lates">
        <div class="container">
            ...
            <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                <img src="{{url('images/4.jpg')}}" class="img-responsive" />
